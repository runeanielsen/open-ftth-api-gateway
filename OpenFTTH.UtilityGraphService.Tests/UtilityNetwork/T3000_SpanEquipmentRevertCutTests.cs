...
{
    [Order(3000)]
    public class T3000_SpanEquipmentRevertCutTests
    {
        ...
        public T3000_SpanEquipmentRevertCutTests(IEventStore eventStore, ICommandDispatcher commandDispatcher, IQueryDispatcher queryDispatcher, IExternalEventProducer externalEventProducer)
        {
