...
{
    public class UtilityGraphInternalEquipmentConnectivityNode : GraphNode, IUtilityInternalEquipmentConnectivityRef
    {
        public Guid RouteNodeId { get; }
        public Guid TerminalEquipmentId { get; }
        public ushort StructureIndex { get; }

        public UtilityGraphInternalEquipmentConnectivityNode(Guid id, Guid terminalEquipmentId, Guid nodeOfInterestId, ushort structureIndex = 0) : base(id)
        {
        ...
        {
            return $"Connectivity node in terminal equipment: {TerminalEquipmentId} structure index: {StructureIndex} route node: {RouteNodeId}";
        }
